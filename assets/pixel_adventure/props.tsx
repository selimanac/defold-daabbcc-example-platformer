...
<tileset version="1.10" tiledversion="1.11.2" name="props" tilewidth="64" tileheight="64" tilecount="18" columns="0">
 ...
 <tile id="9">
  <image source="Background/Brown.png" width="64" height="64"/>
 </tile>
 <tile id="10">
  <image source="Background/Gray.png" width="64" height="64"/>
 </tile>
 <tile id="11">
  <image source="Background/Green.png" width="64" height="64"/>
 </tile>
 <tile id="12">
  <image source="Background/Pink.png" width="64" height="64"/>
 </tile>
 <tile id="13">
  <image source="Background/Purple.png" width="64" height="64"/>
 </tile>
 <tile id="14">
  <image source="Background/Yellow.png" width="64" height="64"/>
 </tile>
